...
module.exports = function (plop) {
    // Set custom delimiters for Handlebars to avoid conflicts with JSX
    plop.setDefaultInclude({ actionOptions: { delimiter: '[[', closingDelimiter: ']]' } });
    ...
    plop.setGenerator('feature', {
        ...
        actions: function (data) {
            ...
            actions.push({
                type: 'add',
                path: 'src/app/admin/[[featureNamePlural]]/page.js',
            ...
            if (data.includeCreate) {
                actions.push({
                    type: 'add',
                    path: 'src/app/admin/[[featureNamePlural]]/create/page.js',
            ...
            if (data.includeEdit) {
                actions.push({
                    type: 'add',
                    path: 'src/app/admin/[[featureNamePlural]]/[id]/page.js',
            ...
            actions.push({
                type: 'add',
                path: 'src/components/admin/[[featureNamePlural]]/.gitkeep',
                template: ''
            });
            ...
            if (data.includeList) {
                actions.push({
                    type: 'add',
                    path: 'src/components/admin/[[featureNamePlural]]/[[PascalFeatureName]]List.js',
            ...
            if (data.includeCreate || data.includeEdit) {
                actions.push({
                    type: 'add',
                    path: 'src/components/admin/[[featureNamePlural]]/[[PascalFeatureName]]Form.js',
            ...
            if (data.includeEdit) {
                actions.push({
                    type: 'add',
                    path: 'src/components/admin/[[featureNamePlural]]/[[PascalFeatureName]]Detail.js',
            ...
            if (data.addNavigation) {
                // Append to end of navigationItems
                actions.push({
                    type: 'modify',
                    path: 'src/components/layout/Sidebar.js',
                    pattern: /(const navigationItems = \[[\s\S]*?)(\n\])/,
                    template: `$1,\n  // [[PascalFeatureName]] feature (generated by plop)\n  {\n    text: '[[proper featureNamePlural]]',\n    icon: <[[icon]]Icon />,\n    path: '/admin/[[featureNamePlural]]',\n    children: [\n      { text: 'All [[proper featureNamePlural]]', path: '/admin/[[featureNamePlural]]' },\n      { text: 'Create [[proper featureName]]', path: '/admin/[[featureNamePlural]]/create' },\n    ]\n  }$2`
                });

                // This pattern assumes your imports look like this:
                // import { DashboardIcon, EventIcon } from '@mui/icons-material';
                actions.push({
                    type: 'append',
                    path: 'src/components/layout/Sidebar.js',
                    pattern: /('|")use client('|");/, // Place after `'use client';`
    ...
    plop.setGenerator('component', {
        ...
        actions: function (data) {
            ...
            if (data.type === 'feature') {
                ...
                componentPath = `src/components/${data.type}/[[feature]]/[[name]].js`;
            } else {
