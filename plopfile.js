        ...
        actions: function (data) {
            ...
            if (data.addNavigation) {
                ...
                actions.push({
                    type: 'modify',
                    path: 'src/components/layout/Sidebar.js',
                    pattern: /(import {[\s\S]*?)\} from '@mui\/icons-material';/,
                    template: `$1, {{icon}}Icon } from '@mui/icons-material';`
                });
