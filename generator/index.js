...
async function generateFeature() {
  ...
  if (data.addNavigation) {
    ...
    // ${PascalFeatureName} feature (generated by mongonext-generator)
    {
      ...
      children: [
        { text: 'All ${data.properFeatureNamePlural}', path: '/admin/${featureNamePlural}', icon: <${data.icon}Icon /> },
        { text: 'Create ${data.properFeatureName}', path: '/admin/${featureNamePlural}/create', icon: <${data.icon}Icon /> },
      ]
    }`;
